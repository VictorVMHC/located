...
const searchLocalWithLikes = (latitude: number, longitude: number, kilometers: number) => {
    const route = `/api/searchLocals/searchLocalsAndLikes/${latitude}/${longitude}/${kilometers}`
